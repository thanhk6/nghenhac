    ...
    public class ModAuthorController : CPController
    {
        ...
        public void ActionIndex(ModBrandModel model)
        {
            ...
            var dbQuery = ModAuthorService.Instance.CreateQuery()
                                ...
                                .WhereIn(o => o.MenuID, WebMenuService.Instance.GetChildIDForCP("Author", model.MenuID, model.LangID))
                                .Take(model.PageSize)
                                .OrderBy(orderBy)
        ...
        {
            return ModAuthorService.Instance.CreateQuery()
                    .Max(o => o.Order)
                    .ToValue().ToInt(0) + 1;
        }
