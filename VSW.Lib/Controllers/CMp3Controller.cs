...
{
    [ModuleInfo(Name = "ĐK: mp3", Code = "CMp3", IsControl = true, Order = 3)]
    public class CMp3Controller : Controller
    {
        ...
        [Core.MVC.PropertyInfo("Chuyên mục", "Type|Mp3")]
        public int MenuID;
        [Core.MVC.PropertyInfo("Trang")]
        public int PageID;
        [Core.MVC.PropertyInfo("Vị trí", "ConfigKey|Mod.Mp3State")]
        public int State;
        [Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 6;
        public override void OnLoad()
        {
            ViewBag.Data = ModMp3Service.Instance.CreateQuery()
            ...
            ViewBag.FlashSale= ModMp3Service.Instance.CreateQuery()
