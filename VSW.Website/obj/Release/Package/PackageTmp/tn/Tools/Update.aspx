...
<script runat="server">
    ...
    protected void btnRun_Click(object sender, EventArgs e)
    {
        var listItem = ModProductService.Instance.CreateQuery()
                                    .WhereIn(o => o.MenuID, WebMenuService.Instance.GetChildIDForWeb_Cache("Product", 58, 1))
                                    .ToList();

        for (int i = 0; listItem != null && i < listItem.Count; i++)
        {
            listItem[i].BrandID = 10;
            ModProductService.Instance.Save(listItem[i], o => o.BrandID);
        }
    }
</script>
