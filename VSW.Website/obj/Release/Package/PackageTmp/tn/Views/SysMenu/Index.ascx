...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Chuyên mục</h3>
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting"><%= GetSortLink("Tên chuyên mục", "Name")%></th>

                                            <%if (model.ParentID == 0){ %>
                                            <th class="sorting text-center hidden-sm hidden-col"><%= GetSortLink("Loại dữ liệu", "Code")%></th>
                                            <%} %>
