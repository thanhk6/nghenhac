...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Tài nguyên <small><%= model.RecordID > 0 ? "Chỉnh sửa": "Thêm mới"%></small></h3>
                                        ...
                                        <div class="portlet-body">
                                            <div class="form-body">
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label text-right">Mã tài nguyên:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea class="form-control custom" name="Value" id="Value" rows="" cols=""><%=item.Value %></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
