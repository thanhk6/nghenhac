...
<form id="vswForm" name="vswForm" method="post">
                                ...
                                <div class="col-12 col-sm-12 col-md-8 col-lg-8 text-right pull-right">
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_menu" class="form-control input-inline input-sm" onchange="VSWRedirect()" size="1">
                                            ...
                                            <%= Utils.ShowDdlMenuByType("ImageProduc", model.LangID, model.MenuID)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                           ...
                                           <%-- <th class="sorting text-center w1p">lllll</th>--%>
                                             <th class="sorting text-center w10p hidden-sm hidden-col"><%= GetSortLink("Ảnh", "File")%></th>

                                            <th class="sorting"><%= GetSortLink("title anh","Title")%></th>
                                             <th class="sorting"><%= GetSortLink("alt anh", "Alt")%></th>                                                                                                                            
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <%--   <td class="text-center">kkkkkkkk</td>--%>
                                            <td>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "ModImageProduc";
