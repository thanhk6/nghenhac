...
<%
    var model = ViewBag.Model as ModImageModel;
    var item = ViewBag.Data as ModProductFileEntity;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Anh phụ <small><%= model.RecordID > 0 ? "Chỉnh sửa": "Thêm mới"%></small></h3>
        <div class="page-bar justify-content-between">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/{CPPath}/<%=CPViewPage.CurrentModule.Code%>/Index.aspx">Anh phụ</a>
                </li>
            </ul>
                                        ...
                                        <div class="portlet-body">
                                            <div class="form-body">
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label text-right">title:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label text-right">Alt:</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control title" name="Alt" value="<%=item.Alt %>" />
                                                        <span class="help-block text-primary">Ký tự đối ta: 200</span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="MenuID" id="MenuID">
                                                            ...
                                                            <%= Utils.ShowDdlMenuByType2("ImageProduc", model.LangID, item.MenuID)%>
                                                        </select>
                                                    </div>
                                                </div>                                     
                                               <%-- <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="MenuID" id="MenuID">
                                                            <option value="0">Root</option>
                                                            <%= Utils.ShowDdlMenuByType2("Gift", model.LangID, item.MenuID)%>
                                                        </select>
                                                    </div>
                                                </div>--%>
                                               <%-- <div class="form-group row">
