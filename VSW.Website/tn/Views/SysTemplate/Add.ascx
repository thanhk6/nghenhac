                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-link">
                                        <a class="#" href="#design" data-toggle="tab">Thiết kế giao diện</a>
                                    </li>
                                </ul>
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <select class="form-control" name="File">
                                                                        ...
                                                                        %>
                                                                        <option <%if (item.File == fileName){%>selected<%} %> value="<%=fileName %>"><%=fileName %></option>
                                                                        <%}%>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea class="form-control custom" name="Custom" id="Custom" rows="" cols=""><%=item.Custom %></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
