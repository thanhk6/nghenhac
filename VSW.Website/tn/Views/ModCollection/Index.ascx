...
<%
    ...
    var listItem = ViewBag.Data as List<ModCollectionEntity>;
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Bộ sưu tập</h3>
                                ...
                                <div class="col-12 col-sm-12 col-md-8 col-lg-8 text-right pull-right">
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_menu" class="form-control input-inline input-sm" onchange="VSWRedirect()" size="1">
                                            ...
                                            <%= Utils.ShowDdlMenuByType("Collection", model.LangID, model.MenuID)%>
                                        </select>
                                        ...
                                        <select id="filter_brand" class="form-control input-inline input-sm" onchange="VSWRedirect()" size="1">
                                            ...
                                            <option value="<%=listBrand[i].ID %>" <%if(model.BrandID == listBrand[i].ID) {%>selected="selected"<%} %>><%=listBrand[i].Name %></option>
                                            <%} %>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_state" class="form-control input-inline input-sm" onchange="VSWRedirect()" size="1">
                                            <option value="0">(Tất cả)</option>
                                            <%= Utils.ShowDdlByConfigkey("Mod.CollectionState", model.State)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting"><%= GetSortLink("Tên ảnh", "Name")%></th>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "ModCollection";
