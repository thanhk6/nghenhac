                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <%if (model.ParentID > 0)
                                            {%>
                                            <th class="sorting text-center hidden-sm hidden-col"><%= GetSortLink("Mã", "Code")%></th>
                                         <%--   <th class="sorting text-center w10p hidden-sm hidden-col"><%= GetSortLink("Ảnh", "File")%></th>--%>
                                            ...
                                            <%--<th class="sorting text-center hidden-sm hidden-col"><%= GetSortLink("Mobile", "TemplateMobileID")%></th>--%>
                                            <%} %>

                                             <th class="sorting text-center w1p"><%= GetSortLink("Show MenuTop", "ShowMenuTop")%></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <%--  <td class="text-center hidden-sm hidden-col">
                                                <img src="<%= Utils.GetResizeFile(listItem[i].File, 4, 40, 40)%>" />
                                            </td>--%>
                                            ...
                                            <%} %>
                                            <td class="text-center">
                                              <%= GetShowMenuTop(listItem[i].ID, listItem[i].ShowMenuTop)%>
                                                </td>
