                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting text-center"><%= GetSortLink("Số điện thoại", "Phone")%></th>
                                            <th class="sorting text-center"><%= GetSortLink("Số lượng", "Address")%></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><%=listItem[i].Address %></td>
