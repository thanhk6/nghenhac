                                        ...
                                        <div class="portlet-body">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="password" class="form-control" name="NewPassword" value="<%=item.Password %>" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                        ...
                                        <div class="portlet-body">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="portlet-title-sub">Avatar</label>
                                                    ...
                                                    <table class="table table-striped clear">
                                                        <tbody>
                                                            <tr class="template-upload">
                                                                <td>
                                                                    <span class="preview"><img src="uploads/pro1.png" alt=""></span>
                                                                </td>
                                                                <td>
                                                                    <p class="name">logo video.png</p>
                                                                </td>
                                                                <td>
                                                                    <p class="name">45.21 KB</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox-list">
                                                        ...
                                                        <label class="itemCheckBox itemCheckBox-sm">
                                                            <input type="checkbox" name="ArrRole" <%if (HasRole(listRole[i].ID)){%> checked="checked" <%} %> value="<%= listRole[i].ID%>">
                                                            <i class="check-box"></i>
