...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Nhãn hiệu</h3>
        <div class="page-bar justify-content-between">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/{CPPath}/<%=CPViewPage.CurrentModule.Code%>/Index.aspx">Nhãn hiệu</a>
                </li>
            </ul>
                                ...
                                <div class="col-12 col-sm-12 col-md-8 col-lg-8 text-right pull-right">
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_menu" class="form-control input-inline input-sm" onchange="VSWRedirect()" size="1">
                                            ...
                                            <%= Utils.ShowDdlMenuByType("Brand", model.LangID, model.MenuID)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                        <label>Vị trí</label>
                                        <select id="filter_state" class="form-control input-inline input-sm" onchange="VSWRedirect()" size="1">
                                            <option value="0">(Tất cả)</option>
                                            <%= Utils.ShowDdlByConfigkey("Mod.BrandState", model.State)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              <%--  <p class="smallsub hidden-sm hidden-col">(<span>Mã</span>: <%= listItem[i].Code%>) - <a href="/<%=listItem[i].Code%>.html" style="color:red;" target="_blank">Xem website</a></p>--%>
                                            </td>
