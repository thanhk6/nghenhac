...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Tạo link tự động</h3>
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting"><%= GetSortLink("Từ khóa", "Name")%></th>
                                            <th class="sorting text-center hidden-sm hidden-col"><%= GetSortLink("Link", "Link")%></th>
                                            <th class="sorting text-center hidden-sm hidden-col"><%= GetSortLink("Tiêu đề", "Title")%></th>
                                            <th class="sorting text-center w10p hidden-sm hidden-col"><%= GetSortLink("Số lượng", "Quantity")%></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center hidden-sm hidden-col"><%=listItem[i].Link%></td>
