                            ...
                            <table class="table table-striped table-hover table-bordered dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sorting text-center w1p hidden-sm hidden-col"><%= GetSortLink("Duyệt", "Activity")%></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="javascript:CloseGift(<%= listItem[i].ID %>)">Chọn</a></td>
                                        <td>
